...
//颜色定义
#define COLOR_RED (FOREGROUND_RED | FOREGROUND_INTENSITY)                                               //红色
#define COLOR_GREEN (FOREGROUND_GREEN | FOREGROUND_INTENSITY)                                           //绿色
#define COLOR_BLUE (FOREGROUND_BLUE | FOREGROUND_INTENSITY)                                             //蓝色
#define COLOR_YELLOW (FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_INTENSITY)                         //黄色
#define COLOR_MAGENTA (FOREGROUND_RED | FOREGROUND_BLUE | FOREGROUND_INTENSITY)                         //品红色
#define COLOR_CYAN (FOREGROUND_GREEN | FOREGROUND_BLUE | FOREGROUND_INTENSITY)                          //青色
#define COLOR_WHITE (FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_BLUE)                               //白色
#define COLOR_GRAY (FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_BLUE | FOREGROUND_INTENSITY)         //灰色
#define COLOR_BLACK (0)                                                                                 //黑色
#define COLOR_DEFAULT (FOREGROUND_RED | FOREGROUND_GREEN | FOREGROUND_BLUE)                             //默认颜色

#define BG_COLOR_RED (BACKGROUND_RED | BACKGROUND_INTENSITY)                                            //背景红色
#define BG_COLOR_GREEN (BACKGROUND_GREEN | BACKGROUND_INTENSITY)                                        //背景绿色
#define BG_COLOR_BLUE (BACKGROUND_BLUE | BACKGROUND_INTENSITY)	                                        //背景蓝色
#define BG_COLOR_YELLOW (BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_INTENSITY)                      //背景黄色
#define BG_COLOR_MAGENTA (BACKGROUND_RED | BACKGROUND_BLUE | BACKGROUND_INTENSITY)                      //背景品红色
#define BG_COLOR_CYAN (BACKGROUND_GREEN | BACKGROUND_BLUE | BACKGROUND_INTENSITY)                       //背景青色
#define BG_COLOR_WHITE (BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE)                            //背景白色
#define BG_COLOR_GRAY (BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE | BACKGROUND_INTENSITY)      //背景灰色
#define BG_COLOR_BLACK (0)                                                                              //背景黑色
#define BG_COLOR_DEFAULT (BACKGROUND_RED | BACKGROUND_GREEN | BACKGROUND_BLUE)                          //背景默认颜色
